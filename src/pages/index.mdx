...
<Figure
    caption="Overview of the VideoPath-LLaVA model architecture and its freezing and tuning strategy at each stage.
      The model comprises three main components: a vision encoder (ViT), a projector, and a large language decoder (LLM)."
  >
    <Image source={fig_network} altText="VideoPath-LLaVA model." />
</Figure>
...
<Figure
    caption="Performance benchmarking of text generation models on VideoPath-Instruct."
  >
    <Image source={fig_table} altText="Performance benchmarking of text generation models on VideoPath-Instruct." />
</Figure>
